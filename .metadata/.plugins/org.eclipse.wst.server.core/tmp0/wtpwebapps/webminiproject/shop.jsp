    ...
    <div class="wrapper fixed__footer">
                        ...
                        <div class="col-md-12">
                            <div class="filter__menu__container">
                                <div class="product__menu">
                                    ...
                                    <button data-filter=".cat--1">Phones</button>
                                    <button data-filter=".cat--2">Earphone</button>
                                </div>
                                    ...
                                    <div class="fiter__content__inner">
                                        <div class="single__filter">
                                            ...
                                            <ul class="filter__list">
                                                ...
                                                <li><a href="#accessories">Earphone</a></li>
		...
		%>
                                    ...
                                    <div class="product__details">
                                        <h2><a href="product-details.html"><%=product.getProductName()%></a></h2>
                            ...
                            <div class="product-info">
                                ...
                                <div class="price-box-3">
                                    <div class="s-price-box">
                                        ...
                                        <span class="old-price">$<%=product.getPrice()*1.2%></span>
                                    </div>
                                </div>
