                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Order Confirmation</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="index.html">Home</a>
                                  <span class="brd-separetor">/</span>
                                  <span class="breadcrumb-item active">Order Confirm</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="ckeckout-left-sidebar">
                            <!-- Start Order Confirmation Area -->
                             <div class="our-important-note">
                                <h2 class="section-title-3">Your Order Details :</h2>
                                <p class="note-desc">Here are your order details.</p>
                                <ul class="important-note">
                                    <p>select data from shoppingpayment table</p>
                                </ul>
                            </div>             
