...
<table border="1">
	...
	<tr>   
		...
		<td>
			<a href="probono?command=activist&activistId=${data.activistId}">${data.activistId}</a>
		</td>
		<td>
	<%-- 		<a href="receiveDetail.jsp" target="_blank">${data.receiveId}</a> --%>
			<a href="probono?command=recipient&receiveId=${data.receiveId}">${data.receiveId}</a>
		</td>
